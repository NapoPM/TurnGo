...
<div class="card container mt-5 col-md-8 justify-content-center  card">
        ...
        <div class="card-body">
        <select class="form-control" id="registroTipo" name="registroTipo" onchange="updateForm()">
            <option value="Seleccionar" selected="select" disabled>--Seleccionar--</option>
            <option value="usuarioFinal">Usuario Final</option>
